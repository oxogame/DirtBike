...
public class BikeController : MonoBehaviour
{
    ...
    public void FixedUpdate()
    {
        ...
        {//case with acceleration from 0.0 to 0.9 throttle
            ...
            coll_rearWheel.motorTorque = EngineTorque * PlayerManager.instance.speed/* outsideControls.Vertical*/;
            //coll_rearWheel.motorTorque = PlayerManager.instance.speed;
        ...
        if (!crashed && outsideControls.Vertical > 0.9f && !isReverseOn)
