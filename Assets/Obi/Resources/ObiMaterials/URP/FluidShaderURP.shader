...
Shader "Obi/URP/Fluid/FluidShading"
{
	...
	SubShader
	{
		...
		Pass
		{
            ...
            sampler2D _Volume; // rgb = color, a = thickness
            float _Metalness;
            float _Transparency;
            ...
            {
                float4 volume = tex2D(_Volume,uv);
			...
			fout frag (v2f i)
			{
                ...
                half3 absorption = half3(1,1,1);
                    ...
                    // Calculates refraction and absorption (using beer's law).
                        ...
                        half3 refraction = tex2D(_CameraOpaqueTexture, i.uv + eyeNormal.xy * volume.a * _RefractionCoeff) * absorption;
