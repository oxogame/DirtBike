...
sampler2D _CameraOpaqueTexture; // background for refraction
sampler2D _Foam;    // foam color / opacity.
sampler2D_half _Normals; // normals
sampler2D_float _FluidSurface;  // depth
...
{
	float eyeZ = tex2D(_FluidSurface, uv).r; // we expect linear depth here.
